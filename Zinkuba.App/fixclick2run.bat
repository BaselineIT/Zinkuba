...
rem Check for Office 2016/365 
reg query HKLM\SOFTWARE\Microsoft\Office\ClickToRun\REGISTRY\MACHINE\Software\Classes\Wow6432Node\CLSID\{4E3A7680-B77A-11D0-9DA5-00C04FD65685} 2>NUL >NUL 
IF %ERRORLEVEL%==0 ( 
echo Click2Run Office 2016/365 Detected, Checking if patch applied 
reg query HKLM\SOFTWARE\Classes\Wow6432Node\CLSID\{4E3A7680-B77A-11D0-9DA5-00C04FD65685} 2>NUL >NUL 
IF !ERRORLEVEL!==1 ( 
echo Unpatched Click2Run Detected, patching 
rem IConverterSession 
